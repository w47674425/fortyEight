class ItemBomb extends ItemEntity{
	public constructor() {
		super();
		this.init();
	}
	public get type(): number { return enumEntityType.ItemBomb }
	protected init(){
		this.image = Common.createBitmapByName("bomb_png");
